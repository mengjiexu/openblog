 ...
 * 
 * @see com.blog.entity.Article
 * @author MyEclipse Persistence Tools
 */
@Transactional
public class ArticleDAO {
	protected static final Logger log = LoggerFactory.getLogger(ArticleDAO.class);
	// property constants
	...
	public static final String LOOKTIMES = "looktimes";
	...
	public List<Article> findByExample(Article instance) {
		...
		try {
			List<Article> results = (List<Article>) getCurrentSession()
					.createCriteria("com.blog.entity.Article")
	...
	public List<Article> findByUid(Object uid) {
	...
	public List<Article> findByTag(Object tag) {
		return findByProperty(TAG, tag);
	}

	public List<Article> findByType(Object type) {
		return findByProperty(TYPE, type);
	}

	public List<Article> findByLooktimes(Object looktimes) {
		return findByProperty(LOOKTIMES, looktimes);
	}
	...
	public List myfindByTag(String tag2) {
		// TODO Auto-generated method stub
		return null;
	}
