...
public class TagDAO {
	...
	public Tag findById(java.lang.Integer id) {
		...
		try {
			Tag instance = (Tag) getCurrentSession().get("com.blog.entity.Tag",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Tag> findByExample(Tag instance) {
		...
		try {
			List<Tag> results = (List<Tag>) getCurrentSession()
					.createCriteria("com.blog.entity.Tag")
	...
	public List<Tag> findByContent(Object content) {
